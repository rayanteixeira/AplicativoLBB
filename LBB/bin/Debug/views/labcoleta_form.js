LBB.labcoleta_form = function (params) {
    ...
    var viewModel = function() {
     ...
     if (self.BDusuario != null) {
         ...
         //endereço cliente
         self.cepCliente = objetoCliente.cepCliente;;
         self.enderecoCliente = objetoCliente.enderecoCliente;
         self.perimetroCliente = objetoCliente.perimetroCliente; 
         self.bairroCliente = objetoCliente.bairroCliente;
         self.cidadeCliente = objetoCliente.cidadeCliente;
